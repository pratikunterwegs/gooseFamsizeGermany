...
distmod = gam(sqrt(distkol) ~ s(famsize) + t_since_in + s(Breeding_year, bs = "re") + s(Food_type, bs = "re") + s(Observer, bs = "re"), data = fams.expand.sub %>% filter(t_since_in < 60), family = "poisson")
