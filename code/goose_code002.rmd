...
6. These included sites where the geocoding did not correctly identify the location and produced ```NA``` values (these were invariably in pairs, ie, both lon-lat were ```NA```) and sites where the geocoding produced coordinates that were not in the study sites defined above. 
