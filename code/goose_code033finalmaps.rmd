...
tm_shape(geeseorg.grid)+
  tm_polygons(col = "grey90",alpha = 0.5, border.col = "grey80", border.alpha = 0.3)+
...
tm_shape(splits2)+
  tm_symbols(shape = "event", shapes = c(25, 4), size = 0.5, col = "grey", showNA = F, shapeNA = NA, border.col = "grey20", legend.shape.show = F)+
