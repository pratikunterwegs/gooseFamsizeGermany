...
```{r map_sovon}
postscript(file = "datamap.eps", horizontal = FALSE, onefile = FALSE)
#'map locations
...
tm_shape(splits2[splits2$event == "Split",])+
  tm_symbols(shape = "event", col = "indianred1", shapes = c(25, 4), size = 0.2, border.col = "grey10", showNA = F, shapeNA = NA, legend.shape.show = F)+
