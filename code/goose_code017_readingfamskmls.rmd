...
library(maptools)
#'create a list of named lists. yes, there are better ways of doing this...like creating a list of lists and then assigning names.
...
```{r savefamtracks}
#'save as file for import later
save(famtracks, "famtracks.Rdata")
```
