...
I then checked to see how the flocksize varied over time from each region. Some regions are very sparsely sampled. I also looked at flock sizes in each region over time.
...
```{r records_region_time, fig.height=7, fig.width=10, fig.cap= "Flock size over time, separated by region. Seven regions have been removed for lack of data."}
#'basic plots
ggplot()+
...
No clear trend was seen in the hexbin representation of data. Records from Wesel and Friesland produced a hexbin plot most similar to the pooled data. Zeeland shows the most irregular pattern, with higher flock sizes (not shown here).

```{r hex_jvprop_flock_rg, fig.cap="Hexbins showing counts of combinations of flocksize and juvenile proportion.", fig.height=5, fig.width=7, include=FALSE}
#'hexbin juvprop flock size
ggplot()+
