...
modjuvs = gam(propjuv ~ p.index + s(t_since_in) + s(Breeding_year, bs = "re") + s(Observer, bs = "re") + s(Food_type, bs = "re"), family = binomial, data = geese)

#'using nolet data
modjuvs2 = gam(propjuv ~ pinnolet + s(Breeding_year, bs = "re") + s(t_since_in) + s(Observer, bs = "re") + s(Food_type, bs = "re"), family = binomial, data = geese)
