...
#'plot sites
ggplot()+
  geom_polygon(data=nl, aes(x=long, y=lat, group = group))+
  geom_point(data = migration.sites, aes(x=Lon, y=Lat, shape = season, col = season), size = 2)+
