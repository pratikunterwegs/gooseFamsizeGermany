...
ggplot()+
  ...
  labs(list(x = "Days since arrival", y= "Split probability"))+
  theme_bw()+a+ylim(NA,0.1)+scale_y_continuous(breaks = c(0,0.05))
...
ggplot()+
  ...
  labs(list(x = "Total flights", y= "Split probability"))+
  theme_bw()+a
...
ggplot()+
  ...
  labs(list(x = "Family size", y= "Split probability"))+
  theme_bw()+a+ylim(NA,0.1)+scale_y_continuous(breaks = c(0,0.05,0.07))
...
ggplot()+
  ...
  labs(list(x = "Distance travelled (100 km)", y= "Split probability"))+
  theme_bw()+a
