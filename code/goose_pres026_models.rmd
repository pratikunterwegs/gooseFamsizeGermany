...
a = theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.ticks.length=unit(-0.25, "cm"), axis.ticks.margin=unit(0.5, "cm"))
b = theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.ticks.length=unit(-0.25, "cm"), axis.ticks.margin=unit(0.5, "cm"))
```
...
p1 = ggplot()+
  ...
  geom_text(aes(x =9, y = 7, label = "{Omega[0]}^2==0.563"), parse = T)+
  theme_bw()+a
#dev.off()
```
...
p3 = ggplot()+
  ...
  ylim(0,7.5)+xlim(3,10)+
  geom_text(aes(x =10, y = c(7,6), label = c("with~0~{Omega[0]}^2==0.786", "w/o~0~{Omega[0]}^2==0.661")), hjust = "inward", parse = T)+
  theme_bw()+a
...
p5 = ggplot()+
  ...
  geom_text(aes(x =9, y = 4500, label = "{Omega[0]}^2==0.99"), hjust = "inward", parse = T)+
  theme_bw()+a
...
p7= ggplot()+
  ...
  geom_text(aes(x =1.5, y = 190, label = "{Omega[0]}^2==0.99"), hjust = "inward", parse = T)+
  theme_bw()+a
...
p9 = ggplot()+
  ...
  ylim(0.05, 0.7)+
  geom_text(aes(x = 200, y = 0.7, label = "R^2==0.104"), hjust = "inward", parse = T)+
  theme_bw()+a
