...
cairo_pdf(filename = "~/git/family_sizes_geese_2018/texts/fig2.pdf", height = 4, width = 4)
#
...
geom_pointrange(aes(x = famsize, y = d.mean, ymin = d.mean-d.ci, ymax = d.mean+d.ci, col = time, shape = time), fatten = 3, fill = "white", stroke = 0.6)+
...
#'point data
  ...
  geom_line(aes(x = t_since_in, y = m.pred, col = data))+
    geom_pointrange(aes(x = t_since_in, y = m.famsize, ymin = m.famsize - ci.famsize, ymax = m.famsize +ci.famsize, col = data, shape = data), fill = "white", fatten = 5, stroke = 0.6, lty = 1, lwd = 0.5)+
  
  scale_shape_manual(values=c(21,24,22))+
  scale_colour_manual(values = c(cola, colb,"grey20"))+
