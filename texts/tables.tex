...
\multicolumn{8}{l}{\textbf{\emph{Terms}}: \emph{1: Number of juveniles per family, 2: Number of families, 3: Flock size,}} \\
...
\midrule
\multicolumn{6}{l}{\textbf{\emph{Terms}}: \emph{1: Split occurrence , 2: Family size, 3: Days since autumn arrival,}}\\
